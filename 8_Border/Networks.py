...
class Vor_network(object):
    ...
    def __init__(self, n, bounded = True, coord = None):
        ...
        self.G = nx.Graph()
        self.G.add_nodes_from(range(0,self.n-1))
    ...
    def __init__(self, n_0, average_degreee_0, n, m, degree_only=False):
        ...
        for j in range(1, self.n-self.n_0+1):
            ...
            for i in range(self.m):
                ...
                self.G.add_edge(self.n_0+j-1, new_edge[i])
...
#%% Classe da rede de Barabasi-Albert (criada a partir de uma Watts-Strogatz)

class BA_v2_network(object):
    
    def __init__(self, n_0, average_degreee_0, p, n, m, degree_only=False):
        ...
        # Cria grafo inicial como uma rede de Erdos-Renyi
        self.G = WS_network(self.n_0, self.average_degreee_0, self.p).G
        new_edge = np.zeros(self.m)
